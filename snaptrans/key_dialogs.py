...
class EntryDialog(QDialog):
    ...
    def __init__(self, parent, entry=None, is_dark=True, lang="zh"):
        ...
        self.value_input.setStyleSheet(f"QLineEdit {{ background: {t.bg_input}; color: {t.text_primary}; border: 1px solid {t.border_subtle}; border-radius: 6px; padding: 4px 8px; font-size: 12px; }}")
        key_row.addWidget(self.value_input, 8)

        copy_btn = QPushButton("📋")
        copy_btn.setFixedHeight(36)
        copy_btn.setStyleSheet(f"QPushButton {{ background: transparent; border: 1px solid {t.border_subtle}; border-radius: 4px; font-size: 10px; min-width:10px; max-width:10px; }} QPushButton:hover {{ background: {t.bg_active}; }}")
        ...
        self.eye_btn.setStyleSheet(f"QPushButton {{ background: transparent; border: 1px solid {t.border_subtle}; border-radius: 4px; font-size: 7px; min-width:10px; max-width:10px; }} QPushButton:hover {{ background: {t.bg_active}; }}")
