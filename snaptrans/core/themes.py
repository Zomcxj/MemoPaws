...
def get_main_stylesheet(t: ThemeColors) -> str:
    return f"""
        ...
        QWidget {{ color: {t.text_primary}; font-family: 'JetBrains Mono', 'Microsoft YaHei', 'Segoe UI', monospace; font-size: 12px; selection-background-color: {t.accent}; selection-color: #141413; }}
        QFrame#card {{
