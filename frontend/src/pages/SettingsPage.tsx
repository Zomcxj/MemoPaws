...
export function SettingsPage({ theme, onThemeChange, onLanguageChange }: Props) {
  ...
  return <section className="settings-page">
    ...
    <Group title={t.theme}><Row><SegmentedControl className="settings-segmented" value={theme} options={[["dark", t.dark], ["light", t.light], ["auto", t.auto]]} ariaLabel={t.themeMode} onChange={(v) => onThemeChange(v as ThemeMode)} /></Row></Group>
