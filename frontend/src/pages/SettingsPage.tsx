...
export function SettingsPage({ theme, onThemeChange, onLanguageChange }: Props) {
  ...
  return <section className="settings-page">
    ...
    <Group title={t.theme}><Row><SegmentedControl value={theme} options={[["dark", t.dark], ["light", t.light]]} ariaLabel={t.themeMode} onChange={(v) => onThemeChange(v as Theme)} /></Row></Group>
